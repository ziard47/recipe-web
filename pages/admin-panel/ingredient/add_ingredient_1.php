...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            <form class="form" action="add_ingredient_2.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="name">Ingredient Name</label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="cheese">
                </div>
