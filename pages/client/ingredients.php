		...
		<div class="container">
			...
			<div class="navbar-wrapper">
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<li class="active_1 clearfix"><a href="ingredients.php">Ingredients</a></li>
					<li><a href="about.php">About</a></li>
   ...
   <div class="col-sm-12">
    <div class="about_1">
	   <ul>
		   ...
		   <li><span class="panel_1">Ingredients</span></li>
	   </ul>
	</div>
   </div>
  </div>
 ...
 <div class="container">
  <div class="row">
	 <?php
			...
			// Retrieve the ingredient data from the database
			$query = "SELECT * FROM ingredient";
			$result = $mysqli->query($query);

			if ($result && $result->num_rows > 0) {
			// Loop through each ingredient record
			while ($row = $result->fetch_assoc()) {
				...
				<div class="recipe_2_i clearfix">
					<a href=""><img src="../../ingredient_images/large/{$picture}" class="iw"></a>
					<h4><a href="">{$ingredientName}</a></h4>
				</div>
				</div>
			HTML;
