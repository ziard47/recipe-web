...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $mysqli->prepare("INSERT INTO cus_log (name, email, phone, password, username) VALUES (?, ?, ?, ?, ?)");
   ...
   <div class="col-sm-12">
    <div class="about_1">
	   <ul>
		   ...
		   <li><span class="panel_1">Sign Up</span></li>
	   </ul>
	</div>
   </div>
  </div>
        ...
        <div class="login-page">
            <div class="form">
				...
				<form class="login-form" action="" method="post" enctype="multipart/form-data">
                  ...
                  <input type="text" placeholder="username" name="username" required onkeypress="return blockSpace(event)" />
                  <input type="password" placeholder="Password" name="password" required/>
                  <button type="submit">Sign Up</button>
                  <p class="message">Already registered? <a href="customer_login_1.php">Login</a></p>
                </form>
